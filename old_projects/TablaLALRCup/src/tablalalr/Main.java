...
public class Main extends QMainWindow {
    ...
    public void generarTabla() {
        ...
        try {
            ...
            tablaLR1 = new TablaLALR(reglasGramatica);
        } catch (Exception ex) {
	...
	i = 0;
        for (Grupo gi : tablaLR1.getGramatica().getConjuntos()) {
            colItem = new QTableWidgetItem();
            String tmpNombre = "";
            tmpNombre += gi.getNombre();
            colItem.setText(com.trolltech.qt.core.QCoreApplication.translate("MainWindow", tmpNombre, null));
