...
class Yylex implements java_cup.runtime.Scanner {
    ...
    private int yy_cmap[] = unpackFromString(1, 130,
            "0:9,8:2,0,8:2,0:18,4,0:6,1,2:4,0,3,0,2,1:10,0,7,0:2,6,2,1:27,0:3,1,0:2,1:26" +
            ",0,5,0,1,0,9:2")[0];
    private int yy_rmap[] = unpackFromString(1, 10,
            "0,1,2:5,3,4,2")[0];
    private int yy_nxt[][] = unpackFromString(5, 10,
            "-1,1,7,8,2,3,-1,4,2,5,-1,1,-1:2,9,-1:19,9,-1:9,9,-1,6,-1:3");
