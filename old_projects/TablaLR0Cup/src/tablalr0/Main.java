...
public class Main extends QMainWindow {
    ...
    public Main() {
        ...
        mainWindow.actionTabla_LR0.triggered.connect(this, "acerca()");
    ...
    public void generarTabla() {
        ...
        try {
            ...
            tablaLR0 = new TablaLR0(reglasGramatica);
        } catch (Exception ex) {
        ...
        mainWindow.tableWidget.clear();
        mainWindow.tableWidget.setColumnCount(tablaLR0.getHeaders().length);


        i = 0;

        for (String s : tablaLR0.getHeaders()) {
        ...
        mainWindow.tableWidget.setRowCount(tablaLR0.rowCount());

        for (i = 0; i < tablaLR0.rowCount(); i++) {
            colItem = new QTableWidgetItem();
        ...
        i = 0;
        for (String s : tablaLR0.getHeaders()) {
            for (j = 0; j < tablaLR0.rowCount(); j++) {
                if ((r = tablaLR0.get(String.valueOf(j), s)) != null) {
                    colItem = new QTableWidgetItem();
                    colItem.setText(r);
